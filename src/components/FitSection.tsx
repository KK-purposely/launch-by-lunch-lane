  ...
  return (
    <section className="w-full py-16 px-4 sm:px-6 bg-gradient-to-br from-orange-50 to-white">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-16 bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent">
            ...
            {fractionalQuestions.map((question, index) => (
              <div key={index} className="flex items-start gap-4 text-left">
                <div className="flex-shrink-0 mt-1">
                  <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-r from-lbl-ink to-lbl-orange text-white font-semibold text-sm">
                    {index + 1}
                  </span>
                </div>
        ...
        <div className="inline-flex items-center gap-3 bg-white px-6 py-4 rounded-lg shadow-md border border-orange-100">
          <CheckCircle className="h-6 w-6 text-lbl-orange" />
          <p className="text-lg font-semibold text-gray-800">
            If you answered yes, Launch by Lunch is the right place for you.
          </p>
        </div>
      </div>
    </section>
