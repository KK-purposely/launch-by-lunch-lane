      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            A team that's taught over 100 AI courses, written millions of lines of code, and untangled hundreds of bugs, all using only natural language. We are AI strategists, developers, and coaches that won't let you fail.
          </p>
        </div>
