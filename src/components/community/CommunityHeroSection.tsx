    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="text-center mb-3">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent mb-3">
            <Sparkles className="h-5 w-5 text-lbl-orange animate-pulse" />
            <span className="text-xs font-semibold uppercase tracking-wide">Elite Network</span>
            <Sparkles className="h-5 w-5 text-lbl-ink animate-pulse" />
          </div>
          ...
          <div className="mb-5">
            <p className="text-lg md:text-xl text-gray-700 mb-6 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="text-lbl-orange font-semibold"> AI-first startups</span>
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                variant="outline"
                size="lg"
                className="border-lbl-orange text-lbl-orange hover:bg-lbl-orange hover:text-white rounded-full px-8 font-medium transition-all duration-300"
                onClick={() =>
              ...
              <Button
                size="lg"
                className="bg-lbl-orange hover:bg-lbl-orange/90 text-white rounded-full px-8 font-medium transition-all duration-300"
                onClick={() =>
