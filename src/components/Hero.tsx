      ...
      <div className="relative w-full py-8 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
            AI is only powerful when it actually works for your team — not against it. We cut through the noise and give leaders the right tools, training, and strategy to adopt AI with confidence.
          </p>
