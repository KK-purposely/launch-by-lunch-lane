...
export const DashboardMock: React.FC<DashboardMockProps> = ({ square = false, compact = false, className = "" }) => {
  const wrapperClass = `relative bg-white text-gray-900 rounded-2xl ${square || compact ? "p-3 md:p-4" : "p-5 md:p-6"} ${className}`;
    ...
    return (
      <div className={wrapperClass} style={shadow}>
        <div className="flex items-center justify-between mb-2">
          <div className="text-[10px] font-semibold text-gray-700">This Month</div>
        ...
        <div className="grid grid-cols-5 gap-2">
          {/* Revenue tile */}
          <div
            className="col-span-2 rounded-lg p-2 text-white flex flex-col items-center justify-center text-center min-h-[70px]"
            style={{ background: "linear-gradient(135deg, #421f52 0%, #ec4795 100%)" }}
          >
            <div className="text-[8px] font-semibold uppercase tracking-[0.15em] opacity-90">Revenue</div>
            <div className="text-xl font-extrabold leading-none mt-1">$48.2k</div>
            <div className="text-[8px] opacity-95 mt-1 flex items-center justify-center gap-0.5">
              <span>▲</span> 18% on pace
            </div>
          </div>

          {/* Must Do tile */}
          <div className="col-span-3 rounded-lg border border-gray-200/80 bg-white p-2 min-h-[70px]">
            <div className="flex items-center gap-1 mb-1">
              <AlertTriangle className="h-2 w-2 text-red-500" />
              <span className="text-[7px] font-bold uppercase tracking-[0.15em] text-red-500">Must Do</span>
            </div>
            <ul className="space-y-0.5">
              {[
                ...
                <li key={r.name} className="flex justify-between items-start text-[8px]">
                  <div className="leading-tight">
                    <div className="font-semibold text-gray-900">{r.name}</div>
                    <div className="text-[7px] text-red-500">{r.days} days overdue</div>
                  </div>
          ...
          {/* Revenue trend */}
          <div className="col-span-3 rounded-lg border border-gray-200/80 p-2">
            <div className="text-[7px] font-semibold uppercase tracking-[0.15em] text-gray-500 mb-1">Revenue Trend</div>
            <svg viewBox="0 0 100 40" className="w-full h-7" preserveAspectRatio="none">
              <defs>
          ...
          {/* Goal donut */}
          <div className="col-span-2 rounded-lg border border-gray-200/80 p-2 flex flex-col items-center">
            <div className="text-[7px] font-semibold uppercase tracking-[0.15em] text-gray-500 mb-1 self-start">Goal</div>
            <div className="relative w-8 h-8">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[9px] font-extrabold text-gray-900">74%</span>
              </div>
            </div>
            <span className="text-[7px] text-gray-500 mt-0.5">of target</span>
          </div>
        </div>
      </div>
    );
