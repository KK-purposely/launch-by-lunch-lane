...
import { BrainOrb as HeroOrb } from "@/components/visuals/BrainOrb";
      ...
      <section id="pricing" className="bg-white py-20 md:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-[900px] mx-auto">
            ...
            <div className="bg-white rounded-2xl border-2 border-lbl-orange shadow-lg overflow-hidden">
              <div
              ...
              <div className="p-7">
                <ul className="space-y-4 mb-8">
                  {[
                    ...
                    "5 tool connectors",
                    "25 documents",
                    "Setup for up to 15 people",
                    "2 hours of training for the team",
                    "Ownership handoff",
                  ].map((f) => (
