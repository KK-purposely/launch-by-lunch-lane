        ...
        <div className="relative w-full">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-16 pt-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-6">
              Reach Elite <span className="bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent">AI Builders</span>
            </h1>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white rounded-2xl p-8 shadow-lg text-center border-2 border-lbl-ink/10 hover:border-lbl-ink/30 transition-all">
                <Users className="w-12 h-12 mx-auto mb-4 text-lbl-orange" />
                <div className="text-4xl font-bold bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent mb-2">200+</div>
                <div className="text-gray-600">Active AI Builders</div>
              </div>
              
              <div className="bg-white rounded-2xl p-8 shadow-lg text-center border-2 border-lbl-ink/10 hover:border-lbl-ink/30 transition-all">
                <Target className="w-12 h-12 mx-auto mb-4 text-lbl-orange" />
                <div className="text-4xl font-bold bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent mb-2">72%</div>
                <div className="text-gray-600">Daily Active Users</div>
              </div>
              
              <div className="bg-white rounded-2xl p-8 shadow-lg text-center border-2 border-lbl-ink/10 hover:border-lbl-ink/30 transition-all">
                <Zap className="w-12 h-12 mx-auto mb-4 text-lbl-orange" />
                <div className="text-4xl font-bold bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent mb-2">600+</div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {/* Connector Package */}
                <div className="relative bg-gradient-to-br from-white to-orange-50/30 rounded-2xl p-8 shadow-xl border-2 border-lbl-ink/20 hover:shadow-2xl transition-all">
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-lbl-ink to-lbl-orange text-white px-4 py-1 rounded-full text-sm font-semibold">
                    Most Popular
                  </div>
                  ...
                  <div className="mb-6">
                    <span className="text-4xl font-bold bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent">$2500</span>
                    <span className="text-gray-600 ml-2">per year</span>
                  </div>
                  
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-lbl-ink/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <div className="w-2 h-2 rounded-full bg-lbl-ink"></div>
                      </div>
                  ...
                  <Button 
                    className="w-full bg-gradient-to-r from-lbl-ink to-lbl-orange hover:from-lbl-orange hover:to-lbl-ink text-white py-6 text-lg rounded-full font-semibold shadow-lg"
                ...
                {/* Embedded Package */}
                <div className="relative bg-gradient-to-br from-white to-purple-50/30 rounded-2xl p-8 shadow-xl border-2 border-lbl-orange/20 hover:shadow-2xl transition-all">
                  ...
                  <div className="mb-6">
                    <span className="text-4xl font-bold bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent">$6900</span>
                    <span className="text-gray-600 ml-2">per year</span>
                  </div>
                  
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-lbl-orange/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <div className="w-2 h-2 rounded-full bg-lbl-orange"></div>
                      </div>
            ...
            <div className="mb-16">
              ...
              <div className="max-w-2xl mx-auto bg-gradient-to-br from-white to-orange-50/30 rounded-2xl p-8 shadow-xl border-2 border-lbl-ink/20">
                <h3 className="text-2xl font-bold mb-4 text-gray-800">Demo + Q&A Session</h3>
                
                <div className="mb-6">
                  <span className="text-4xl font-bold bg-gradient-to-r from-lbl-ink to-lbl-orange bg-clip-text text-transparent">$450</span>
                </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-lbl-ink/20 to-lbl-orange/20 flex items-center justify-center">
                    <BookOpen className="w-8 h-8 text-lbl-ink" />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-lbl-ink/20 to-lbl-orange/20 flex items-center justify-center">
                    <ThumbsUp className="w-8 h-8 text-lbl-ink" />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-lbl-ink/20 to-lbl-orange/20 flex items-center justify-center">
                    <Share2 className="w-8 h-8 text-lbl-ink" />
                  </div>
            ...
            {/* Final CTA */}
            <div className="text-center bg-gradient-to-br from-lbl-ink/10 to-lbl-orange/10 rounded-2xl p-12">
