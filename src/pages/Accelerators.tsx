  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <p className="text-xl font-semibold text-center text-gray-700 mb-12">If code and cost stands between you and your vision, this accelerator is for you. Learn how to vibe code a working prototype in just an hour or two.</p>
